...
class yolo_detectionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type yolo_detectionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type yolo_detectionRequest
    let len;
    let data = new yolo_detectionRequest(null);
  ...
  static datatype() {
    ...
    return 'second_coursework/yolo_detectionRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new yolo_detectionRequest(null);
...
class yolo_detectionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type yolo_detectionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type yolo_detectionResponse
    let len;
    let data = new yolo_detectionResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.boxes[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new yolo_detectionResponse(null);
    ...
    if (msg.boxes !== undefined) {
      ...
      for (let i = 0; i < resolved.boxes.length; ++i) {
        resolved.boxes[i] = geometry_msgs.msg.Point.Resolve(msg.boxes[i]);
      }
    }
    else {
      resolved.boxes = []
...
module.exports = {
  Request: yolo_detectionRequest,
  Response: yolo_detectionResponse,
  md5sum() { return '00a6e04d83887597d8140a6f1ebc3e57'; },
  datatype() { return 'second_coursework/yolo_detection'; }
};
