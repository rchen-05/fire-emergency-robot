...
class PatrolActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PatrolFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PatrolActionFeedback(null);
    ...
    data.feedback = PatrolFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PatrolActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PatrolFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PatrolFeedback()
    }
...
module.exports = PatrolActionFeedback;
