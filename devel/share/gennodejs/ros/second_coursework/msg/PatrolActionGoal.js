...
class PatrolActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PatrolGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PatrolActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PatrolGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PatrolGoal()
    }
...
module.exports = PatrolActionGoal;
