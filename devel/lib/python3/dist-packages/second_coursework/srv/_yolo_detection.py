...
"""autogenerated by genpy from second_coursework/yolo_detectionRequest.msg. Do not edit."""
import codecs
import sys
...
class yolo_detectionRequest(genpy.Message):
  _md5sum = "b13d2865c5af2a64e6e30ab1b56e1dd5"
  _type = "second_coursework/yolo_detectionRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(yolo_detectionRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from second_coursework/yolo_detectionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class yolo_detectionResponse(genpy.Message):
  _md5sum = "30abc870f861b6689711ba995ff0a06e"
  _type = "second_coursework/yolo_detectionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 z
"""
  __slots__ = ['labels','confidences','boxes']
  _slot_types = ['string[]','float32[]','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(yolo_detectionResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class yolo_detection(object):
  ...
  _md5sum = '00a6e04d83887597d8140a6f1ebc3e57'
  _request_class  = yolo_detectionRequest
  _response_class = yolo_detectionResponse
